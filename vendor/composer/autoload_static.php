...
class ComposerStaticInit2bc4f313dba415539e266f7ac2c87dcd
{
    ...
    public static $classMap = array (
        ...
        'app\\admin\\Model\\Enterprise' => __DIR__ . '/../..' . '/application/admin/model/Enterprise.php',
        'app\\admin\\controller\\Admins' => __DIR__ . '/../..' . '/application/admin/controller/Admins.php',
        'app\\admin\\controller\\AjaxAction' => __DIR__ . '/../..' . '/application/admin/controller/AjaxAction.php',
        'app\\admin\\controller\\Conf' => __DIR__ . '/../..' . '/application/admin/controller/Conf.php',
        'app\\admin\\controller\\Demand' => __DIR__ . '/../..' . '/application/admin/controller/Demand.php',
        'app\\admin\\controller\\Device' => __DIR__ . '/../..' . '/application/admin/controller/Device.php',
        'app\\admin\\controller\\Enterprise' => __DIR__ . '/../..' . '/application/admin/controller/Enterprise.php',
        'app\\admin\\controller\\Expert' => __DIR__ . '/../..' . '/application/admin/controller/Expert.php',
        'app\\admin\\controller\\Gain' => __DIR__ . '/../..' . '/application/admin/controller/Gain.php',
        'app\\admin\\controller\\GainVideo' => __DIR__ . '/../..' . '/application/admin/controller/GainVideo.php',
        ...
        'app\\admin\\controller\\News' => __DIR__ . '/../..' . '/application/admin/controller/News.php',
        'app\\admin\\controller\\Power' => __DIR__ . '/../..' . '/application/admin/controller/Power.php',
        'app\\admin\\controller\\Users' => __DIR__ . '/../..' . '/application/admin/controller/Users.php',
        'app\\admin\\controller\\base\\Base' => __DIR__ . '/../..' . '/application/admin/controller/base/Base.php',
        'app\\admin\\model\\Access' => __DIR__ . '/../..' . '/application/admin/model/Access.php',
        'app\\admin\\model\\Admin' => __DIR__ . '/../..' . '/application/admin/model/Admin.php',
        'app\\admin\\model\\Citys' => __DIR__ . '/../..' . '/application/admin/model/Citys.php',
        'app\\admin\\model\\Conf' => __DIR__ . '/../..' . '/application/admin/model/Conf.php',
        'app\\admin\\model\\Demand' => __DIR__ . '/../..' . '/application/admin/model/Demand.php',
        'app\\admin\\model\\Device' => __DIR__ . '/../..' . '/application/admin/model/Device.php',
        'app\\admin\\model\\Expert' => __DIR__ . '/../..' . '/application/admin/model/Expert.php',
        'app\\admin\\model\\Gain' => __DIR__ . '/../..' . '/application/admin/model/Gain.php',
        'app\\admin\\model\\GainVideo' => __DIR__ . '/../..' . '/application/admin/model/GainVideo.php',
        'app\\admin\\model\\News' => __DIR__ . '/../..' . '/application/admin/model/News.php',
        'app\\admin\\model\\Role' => __DIR__ . '/../..' . '/application/admin/model/Role.php',
        'app\\admin\\model\\Rule' => __DIR__ . '/../..' . '/application/admin/model/Rule.php',
        'app\\admin\\model\\Users' => __DIR__ . '/../..' . '/application/admin/model/Users.php',
        'app\\api\\controller\\Login' => __DIR__ . '/../..' . '/application/api/controller/Login.php',
        ...
        'think\\oracle\\Builder' => __DIR__ . '/..' . '/topthink/think-oracle/src/Builder.php',
        'think\\oracle\\Connection' => __DIR__ . '/..' . '/topthink/think-oracle/src/Connection.php',
        'think\\paginator\\driver\\Bootstrap' => __DIR__ . '/../..' . '/thinkphp/library/think/paginator/driver/Bootstrap.php',
        'think\\paginator\\driver\\Layui' => __DIR__ . '/../..' . '/thinkphp/library/think/paginator/driver/Layui.php',
