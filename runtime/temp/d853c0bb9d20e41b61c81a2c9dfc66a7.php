<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/Applications/MAMP/htdocs/bbbbbb/public/../application/admin/view/demand/audit.html";i:1582644009;s:73:"/Applications/MAMP/htdocs/bbbbbb/application/admin/view/public/title.html";i:1581519893;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
  ...
  <script>
    layui.use(['form'], function(){
      ...
      form.on('submit(audit)', function(data){
        ...
        $.post('<?php echo url("demand/audit"); ?>',data.field,function (res) {
          if (res.icon == 6){
