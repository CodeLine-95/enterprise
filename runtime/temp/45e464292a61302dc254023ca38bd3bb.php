<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/Applications/MAMP/htdocs/bbbbbb/public/../application/admin/view/demand/add.html";i:1582642402;s:73:"/Applications/MAMP/htdocs/bbbbbb/application/admin/view/public/title.html";i:1581519893;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <select name="eid" id="eid">
                  ...
                  <option value="<?php echo $a['id']; ?>"><?php echo $a['user_name']; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
  ...
  <script>
    layui.use(['form','upload','laydate','layedit'], function(){
      ...
      form.on('submit(add)', function(data){
        ...
        $.post('<?php echo url("demand/add"); ?>',data.field,function (res) {
          if (res.icon == 6){
