<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/Applications/MAMP/htdocs/bbbbbb/public/../application/admin/view/product/lists.html";i:1582119756;s:73:"/Applications/MAMP/htdocs/bbbbbb/application/admin/view/public/title.html";i:1581519893;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
    ...
    <div class="layui-tab layui-tab-brief">
      <crmblok>
          <div style="position: relative;">
            ...
            <button class="layui-btn layui-btn-normal" onclick="crm_admin_show('添加','<?php echo url('product/add'); ?>')"><i class="layui-icon">&#xe608;</i>添加</button>
...
<!--              <th align="center">价格</th>-->
          ...
          <?php else: foreach($list as $l): ?>
              <tr>
                ...
                <td><?php if(!empty($l['pic'])): ?><img src="<?php echo $l['pic']; ?>" alt=""><?php endif; ?></td>
                <td><?php echo $l['cate_name']; ?></td>
                <td>
                  <?php switch($l['type']): case "1": ?>汽车<?php break; case "2": ?>导游<?php break; case "3": ?>景点<?php break; endswitch; ?>
                </td>
<!--                <td><?php echo $l['price']; ?></td>-->
                ...
                <td>
                	<button class="layui-btn layui-btn-normal layui-btn-sm" onclick="crm_admin_show('编辑','<?php echo url('product/edit',['id'=>$l['id']]); ?>')">编辑</button>
  ...
  <script>
    ...
    function delAll()
    {
      ...
      layer.confirm("确认删除选择的商品吗？",function(){
        $.post("<?php echo url('product/del'); ?>",{id:JSON.stringify(datas)},function (res) {
          layer.msg(res.msg,{icon:res.icon,time:1000},function(){
            window.location.reload();
          });
        },'json');
