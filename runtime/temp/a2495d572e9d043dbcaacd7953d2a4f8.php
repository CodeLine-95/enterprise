<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/Applications/MAMP/htdocs/bbbbbb/public/../application/admin/view/users/lists.html";i:1582272717;s:73:"/Applications/MAMP/htdocs/bbbbbb/application/admin/view/public/title.html";i:1581519893;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
...
<div class="layui-fluid" class="layui-form">
    ...
    <div class="layui-tab layui-tab-brief">
      <crmblok>
          <div style="position: relative;">
            ...
            <button class="layui-btn layui-btn-normal" onclick="crm_admin_show('添加','<?php echo url('users/add'); ?>')"><i class="layui-icon">&#xe608;</i>添加</button>
      ...
      <table class="layui-table">
          ...
          <?php else: foreach($list as $l): ?>
              <tr>
                ...
                <td><?php echo $l['user_nick']; ?></td>
                <td><?php if(!empty($l['user_face'])): ?><img src="<?php echo $l['user_face']; ?>" alt=""><?php endif; ?></td>
                <td><?php if($l['user_sex'] == 0): ?>男<?php elseif($l['user_sex'] == 1): ?>女<?php else: ?>保密<?php endif; ?></td>
                <td><?php echo $l['user_city']; ?></td>
                <td>
                ...
                <td>
                  <button class="layui-btn layui-btn-normal layui-btn-sm" onclick="reset_password('<?php echo $l['id']; ?>')">重置密码</button>
                	<button class="layui-btn layui-btn-normal layui-btn-sm" onclick="crm_admin_show('编辑','<?php echo url('users/edit',['id'=>$l['id']]); ?>')">编辑</button>
  ...
  <script>
    function reset_password(id){
      layer.confirm("您确定要重置密码 (默认密码：<?php echo $conf['pwd']; ?>) 吗？",function(){
  			$.ajax({
  				url:"<?php echo url('users/reset_password'); ?>",
  				data:{id:id},
  				type:'post',
