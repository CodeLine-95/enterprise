<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/Applications/MAMP/htdocs/bbbbbb/public/../application/admin/view/expert/add.html";i:1582618295;s:73:"/Applications/MAMP/htdocs/bbbbbb/application/admin/view/public/title.html";i:1581519893;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">添加专家</div>
          <div class="layui-form layui-card-body" pad15>
            ...
            <div class="layui-form-item">
              <label class="layui-form-label" for="tags">标签</label>
              <div class="layui-input-block">
                <input type="text" name="tags" id="tags" placeholder="以逗号分隔" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label" for="face">缩略图</label>
              <div class="layui-input-block">
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="text" name="territory" id="territory" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="radio" name="is_show" title="显示" value="1" checked class="layui-input">
                <input type="radio" name="is_show" title="隐藏" value="0" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item">
              <div class="layui-input-block">
  ...
  <script>
    layui.use(['form','upload','laydate','layedit'], function(){
      ...
      form.on('submit(add)', function(data){
        ...
        $.post('<?php echo url("expert/add"); ?>',data.field,function (res) {
          if (res.icon == 6){
