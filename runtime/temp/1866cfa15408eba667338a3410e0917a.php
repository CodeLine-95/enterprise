<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/Applications/MAMP/htdocs/bbbbbb/public/../application/admin/view/device/add.html";i:1582638163;s:73:"/Applications/MAMP/htdocs/bbbbbb/application/admin/view/public/title.html";i:1581519893;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
  ...
  <script>
    layui.use(['form','upload','laydate','layedit'], function(){
      ...
      form.on('submit(add)', function(data){
        $.post('<?php echo url("device/add"); ?>',data.field,function (res) {
          if (res.icon == 6){
