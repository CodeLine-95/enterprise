<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/Applications/MAMP/htdocs/bbbbbb/public/../application/admin/view/expert/edit.html";i:1582620842;s:73:"/Applications/MAMP/htdocs/bbbbbb/application/admin/view/public/title.html";i:1581519893;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="layui-row layui-col-space15">
    <div class="layui-col-md12">
      <div class="layui-card">
        <div class="layui-card-header">编辑专家</div>
        <div class="layui-form layui-card-body" pad15>
          <input type="hidden" name="id" value="<?php echo $field['id']; ?>">
          <div class="layui-form-item">
            <label class="layui-form-label" for="name">标题</label>
            <div class="layui-input-block">
              <input type="text" name="name" value="<?php echo $field['name']; ?>" id="title" lay-verify="required" class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label" for="tags">关键词</label>
            <div class="layui-input-block">
              <input type="text" name="tags" value="<?php echo $field['tags']; ?>" id="tags" placeholder="以逗号分隔" class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
          ...
          <div class="layui-form-item">
            <label class="layui-form-label" for="territory">领域</label>
            <div class="layui-input-block">
              <input type="text" name="territory" value="<?php echo $field['territory']; ?>" id="territory" class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input type="radio" name="is_recommend" title="推荐" value="1" <?php if($field['is_recommend'] == 1): ?>checked<?php endif; ?> class="layui-input">
              <input type="radio" name="is_recommend" title="未推荐" value="0" <?php if($field['is_recommend'] == 0): ?>checked<?php endif; ?> class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">显示</label>
            <div class="layui-input-inline">
              <input type="radio" name="is_show" title="显示" value="1" <?php if($field['is_show'] == 1): ?>checked<?php endif; ?> class="layui-input">
              <input type="radio" name="is_show" title="隐藏" value="0" <?php if($field['is_show'] == 0): ?>checked<?php endif; ?> class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
            <div class="layui-input-block">
...
<script>
  layui.use(['form','upload','laydate','layedit'], function(){
    ...
    form.on('submit(add)', function(data){
      ...
      $.post('<?php echo url("news/edit"); ?>',data.field,function (res) {
        if (res.icon == 6){
